...
<div style={{ width: '100vh', height: '100vh', display: 'flex', alignItems:'center', justifyContent: 'space-between'}}>
<ZoomSteps>
  <ImageDeck deckImage={DECK_IMAGES.ROCKET} style={{ width: '128px', height: '128px' }} />
  <ImageDeck deckImage={DECK_IMAGES.SEO} style={{ width: '128px', height: '128px' }} />
</ZoomSteps>
</div>
