...
import { DevDependenciesSlide } from './slides/DevDependencies.js'
...
# With great traction, comes great responsibility
...
<ImageDeck width={'100%'} height={'100%'} deckImage={DECK_IMAGES.BUILDER_2} styles={{backgroundSize: 'cover'}} />
...
<ImageDeck width={'100%'} height={'100%'} deckImage={DECK_IMAGES.MUI_BUTTON} styles={{backgroundSize: 'cover'}} />

<Steps>

<div>
  <RandomlyPlaced top={29} left={39} style={{width: '20%', height: '20%'}}>
    <ImageDeck deckImage={DECK_IMAGES.COMPONENTS_ONLY_MODE} width={'100%'} height={'100%'} />
  </RandomlyPlaced>
</div>
...
```js
<Fireworks count={3} colors={['#cc3333', '#4CAF50', '#81C784']} interval={500} />
``` 
