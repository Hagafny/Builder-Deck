...
import { SummarySlide } from './slides/SummarySlide.js';
...
## Code releases became the b   ottleneck of the business

<ClosedBottleneck initialDelay={1000} interval={300} />
...
>
  <ZoomSteps>
    ...
    <ImageDeck deckImage={DECK_IMAGES.DEVELOPERS} style={{ width: '128px', height: '128px' }}/> 
    <ImageDeck deckImage={DECK_IMAGES.DESIGN} style={{ width: '128px', height: '128px' }}/> 
    <ImageDeck deckImage={DECK_IMAGES.PRODUCT} style={{ width: '128px', height: '128px' }}/> 
    <ImageDeck deckImage={DECK_IMAGES.MARKETING} style={{ width: '128px', height: '128px' }}/> 
